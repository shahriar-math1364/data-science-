...
The dataset comprises images of Katy Perry, Rihanna, Beyoncé, and Lady Gaga, stored in folders named after the respective celebrity. The images are then preprocessed, and the cropped face sections are stored in separate folders.
